 ...
 *   },
 *   links = {
 *     "delete-form" = "/admin/commerce/product-attributes/manage/{commerce_product_attribute}/values/{commerce_product_attribute_value}/delete",
 *   },
...
class ProductAttributeValue extends ContentEntityBase implements ProductAttributeValueInterface {
  ...
  public function toUrl($rel = 'canonical', array $options = []) {
    ...
    if (in_array($rel, ['canonical', 'revision'])) {
      $route_name = 'entity.commerce_product_attribute.edit_form';
      $route_parameters = [
        'commerce_product_attribute' => $this->getAttributeId(),
      ];
      $options += [
        'query' => [
          'v' => $this->id(),
